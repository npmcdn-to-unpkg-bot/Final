...
-- Schema Laboratorio
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Laboratorio` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
-- -----------------------------------------------------
-- Schema articulos
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `Laboratorio`.`Hclinica` (
  ...
  `nombreFichero` VARCHAR(455) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `articulos`.`zapatos` (
  ...
  `precio` VARCHAR(10) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NOT NULL,
